...
# 2. Further feature selection using Mutual Information and XGBoost-RFE

# Mutual Information
num_features = min(2000, X_lsvc.shape[1])
mi_selector = SelectKBest(mutual_info_classif, k=num_features).fit(X_lsvc, y)
X_mi = mi_selector.transform(X_lsvc)
selected_mi_features = selected_lsvc_features[mi_selector.get_support()]
